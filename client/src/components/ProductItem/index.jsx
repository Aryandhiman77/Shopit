...
const ProductItem = ({ info }) => {
  return (
    <Link className="w-[14vw] min-w-[13rem] max-w-[20rem] p-2 shadow-[0_3px_12px_0.1px_rgba(8,8,8,0.4)] rounded-xl flex justify-around flex-col items-center border-[1px] border-[#e5e5e5] ">
      <img
        className="h-[150px] w-[150px] hover:scale-110 transition-all ease-in-out duration-250 object-contain"
        width={400}
        height={600}
        src="http://localhost:5173/@fs/Users/aryan/Desktop/Projects/e-comm%20images/iphonvar.jpg"
        alt=""
      />
      <div className="details pt-2 mx-2">
        <p className="text-black text-[13px] font-[500]">Iphone 16 black</p>
        <p className="text-black text-[13px] line-clamp-2 ">
          Apple iPhone 16 black, mat back, A18 chipset, dolby vision
        </p>
