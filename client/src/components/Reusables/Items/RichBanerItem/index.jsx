...
const RichBannerItem = ({ bg = "fff", item}) => {
  return (
    <div className={`w-fullrounded-xl shadow-2xl group`} style={{ background: bg }}>
      <div className={`richbannercontainer relative`}>
        <img className=" rounded-xl w-full h-full object-cover group-hover:scale-105 duration-500 transition-all" src={item?.img} alt="" />
        <div
