    ...
    return (
        <div>
            ...
            <div className="additional-details w-full p-3 bg-white">
                <ScrollTab items={[{name:"Description"},{name:"Product Details"}, {name:"Reviews"}]}/>
                <Divider/>
                <p className="text-gray-500 font-[300] text-[15px] p-2">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quod accusantium quos natus quia dignissimos itaque magnam ipsam perferendis odit? Voluptates perspiciatis totam expedita. Optio aliquam aut perferendis quos impedit dolore exercitationem, earum maiores iste blanditiis rerum? Eligendi dicta eveniet placeat quidem voluptate porro sit ex repellendus, sunt aperiam harum odit reiciendis tenetur? Ut eos tempora eveniet neque tempore nulla odio officiis quibusdam, quisquam, reiciendis velit repellendus perferendis harum, mollitia beatae eaque dignissimos facere hic omnis laudantium accusantium voluptatem officia. Itaque minus corrupti nam ullam repudiandae quos reiciendis suscipit libero incidunt totam facere maiores beatae, quam, distinctio maxime odit error! Fuga corporis doloremque voluptatem explicabo fugit cum possimus magnam corrupti assumenda dolores magni velit, quas fugiat quidem? Iste fuga officiis commodi obcaecati ipsum, quasi reiciendis quo sapiente. Sequi impedit architecto libero? Provident accusantium expedita, iure deserunt et asperiores quibusdam exercitationem aut odio, in cum possimus optio necessitatibus beatae recusandae, nesciunt aliquam. Necessitatibus cumque laudantium corporis expedita amet, veniam nesciunt excepturi. Sapiente distinctio doloribus nulla aut veniam, non molestiae fuga, iusto voluptas eius natus pariatur quibusdam laborum? Dolores accusantium quasi excepturi vitae autem fugit, molestiae, sunt mollitia, id exercitationem rerum a numquam unde? Repudiandae dolores itaque architecto quibusdam ab ratione deserunt, sapiente ex sit sunt molestias eligendi quasi mollitia optio perspiciatis. Assumenda voluptates delectus recusandae dolores nemo totam reprehenderit quae fuga? Aspernatur consectetur quam cum cupiditate in molestiae dolorem. Dolor ipsa similique deserunt accusamus accusantium!</p>
            </div>
            <div className="product-section mt-5">
          <div className="header-section flex justify-between ">
            <div>
              <p className="text-xl font-[600] px-5 text-gray-600">Related Products</p>
            </div>
          </div>
