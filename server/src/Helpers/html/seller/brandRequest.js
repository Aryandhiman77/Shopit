      ...
      <table role="presentation" class="email-wrap" width="100%" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td class="lead">
            ...
            We have successfully received your request creating your brand named <strong>${BRAND_NAME}</strong>.
            Your uploaded documents are under verification. Once, your documents get approved, you can manage your brand and add products.
          </td>
        </tr>
        ...
        <tr>
          <td class="notice">
            You can now start managing your brand once your documents are approved by ${COMPANY_NAME}.
