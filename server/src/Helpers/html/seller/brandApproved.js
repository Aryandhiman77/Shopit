...
export const brandApprovedMail = ({
...
<head>
  ...
  <title>Brand Request Approved</title>
  <style>
    ...
    .status { display:inline-block; background:#ecfdf5; border:1px solid #bbf7d0; padding:14px 24px; font-size:16px; font-weight:700; color:#166534; border-radius:8px; }
      ...
      <table role="presentation" class="email-wrap" width="100%" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td class="lead">
            ...
            We’re happy to inform you that your brand named <strong>${BRAND_NAME}</strong> request has been successfully
            <strong>reviewed and approved</strong>. All submitted documents have been verified.
          </td>
        </tr>
        ...
        <tr>
          <td class="notice">
            You can now start managing your brand and add products from your seller dashboard.
...
Hello ${SELLER_NAME},
Your brand request has been approved successfully.
