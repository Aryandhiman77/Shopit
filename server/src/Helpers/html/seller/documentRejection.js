...
export const documentRejection = ({
...
<head>
  ...
  <title>Brand Request Document Rejected</title>
  <style>
      ...
      <table role="presentation" class="email-wrap" width="100%" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td class="lead">
            ...
            The uploaded <strong>${DOC_TYPE}</strong> documents not eligible. Please re-upload the documents.
            <br>
