  ...
  return (
    <div className='flex flex-col gap-4'>
      ...
      <div className="w-[20%]">
        ...
        <Table attributes={["Image","Category Name","Slug","Products","Sub-Category","Leaf-Category","Status","Created At","Modified At","Operations",]}>
            <CategoryRow category={{image:"https://img.freepik.com/free-photo/modern-stationary-collection-arrangement_23-2149309643.jpg",name:"Electronics",slug:"electronics",products:4,level2:{name:"Smart Phones"},level3:{name:"TouchScreen"}}}/>
        </Table>
    </div>
  )
}
